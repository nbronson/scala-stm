...
["#14":https://github.com/nbronson/scala-stm/issues/closed#issue/14] -- fix for external decision support; and
["#15":https://github.com/nbronson/scala-stm/issues/closed#issue/15] -- NPE if a post-decision handler threw an exception.

* Timeouts for modular blocking using @retry@.  Read more at ["Waiting : Timeouts":modular_blocking.html#timeouts].
