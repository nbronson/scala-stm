...
** for 2.10.0-RC1: ["scala-stm_2.10.0-RC1-0.6.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-tools/scala-stm_2.10.0-RC1/0.6/scala-stm_2.10.0-RC1-0.6.jar]
** for 2.9.2: ["scala-stm_2.9.2-0.6.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-tools/scala-stm_2.9.2/0.6/scala-stm_2.9.2-0.6.jar]
** for 2.8.2: ["scala-stm_2.8.2-0.6.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-tools/scala-stm_2.8.2/0.6/scala-stm_2.8.2-0.6.jar]
...
Tell @sbt@ about a dependency on ScalaSTM by adding a library dependency to your @build.sbt@ file (or a Scala build file), and add the oss.sonatype.org repository
