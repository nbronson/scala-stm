...
** for all 2.12 releases: ["scala-stm_2.12-0.8.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-stm/scala-stm_2.12/0.8/scala-stm_2.12-0.8.jar]
** for all 2.11 releases: ["scala-stm_2.11-0.8.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-stm/scala-stm_2.11/0.8/scala-stm_2.11-0.8.jar]
...
* add deprecated message about incomplete deadlock detection for CommitBarrier.
...
The deployment tests inside the ScalaSTM source include a complete ["pom.xml":https://github.com/nbronson/scala-stm/blob/master/dep_tests/maven/pom.xml]
