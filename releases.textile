...
* download a prebuilt JAR for 2.9.1: ["scala-stm_2.9.1-0.3.jar":http://scala-tools.org/repo-releases/org/scala-tools/scala-stm_2.9.1/0.3/scala-stm_2.9.1-0.3.jar]
* download a prebuilt JAR for 2.9.0-1: ["scala-stm_2.9.0-1-0.3.jar":http://scala-tools.org/repo-releases/org/scala-tools/scala-stm_2.9.0-1/0.3/scala-stm_2.9.0-1-0.3.jar]
* download a prebuilt JAR for 2.9.0: ["scala-stm_2.9.0-0.3.jar":http://scala-tools.org/repo-releases/org/scala-tools/scala-stm_2.9.0/0.3/scala-stm_2.9.0-0.3.jar]
* download a prebuilt JAR for 2.8.2: ["scala-stm_2.8.2-0.3.jar":http://scala-tools.org/repo-releases/org/scala-tools/scala-stm_2.8.2/0.3/scala-stm_2.8.2-0.3.jar]
...
Separate artifacts are published for each version of Scala, so the desired Scala version (such as 2.9.1) must be included in the @artifactId@ for Maven (@sbt@ automatically handles this). The ScalaSTM dependency for your @pom.xml@ is
