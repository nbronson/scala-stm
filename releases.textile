...
** for 2.10.0 and future 2.10 releases: ["scala-stm_2.10-0.7.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-stm/scala-stm_2.10/0.7/scala-stm_2.10-0.7.jar]
** for 2.9.2: ["scala-stm_2.9.2-0.7.jar":https://oss.sonatype.org/content/repositories/releases/org/scala-stm/scala-stm_2.9.2/0.7/scala-stm_2.9.2-0.7.jar]
...
* added @transformAndExtract@, which allows an arbitrary value to be returned from the transformation function.
