...
* download a prebuilt JAR for 2.9.0.RC4: ["scala-stm_2.9.0.RC4-0.3.jar":http://scala-tools.org/repo-releases/org/scala-tools/scala-stm_2.9.0.RC4/0.3/scala-stm_2.9.0.RC4-0.3.jar]
...
Separate artifacts are published for each version of Scala, so the desired Scala version (such as 2.9.0.RC4) must be included in the @artifactId@ for Maven (@sbt@ automatically handles this). The ScalaSTM dependency for your @pom.xml@ is

{% highlight xml %}
<dependencies>
  <dependency>
    <groupId>org.scala-tools</groupId>
    <artifactId>scala-stm_2.9.0.RC4</artifactId>
    <version>0.3</version>
  </dependency>
</dependencies>
{% endhighlight %}
