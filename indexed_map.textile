...
h2(#types). Types for the view function and index
...
h2(#indexlist). Tracking and updating indices
...
h2(#source). The source

The code for this example is part of the ScalaSTM source on github: ["IndexedMap.scala":https://github.com/nbronson/scala-stm/blob/master/src/test/scala/scala/concurrent/stm/examples/IndexedMap.scala].
