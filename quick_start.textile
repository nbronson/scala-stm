...
If you use @sbt@, add the following dependency to your project definition class and then run @sbt update@.  Maven2 configuration and manual download links are "here":releases.html.
