...
If you use @sbt@, add the following dependency to your project @build.sbt@ and run @sbt update@.  Maven2 configuration and manual download links are "here":releases.html.
...
If @x@ is a @Ref@, then @x()@ gets the value stored in @x@, and @x() = v@ sets it to the value @v@.
