...
object Test {
  ...
  def main(args: Array[String]) {
    ...
    test("tryAwait is conservative") {
      ...
      assert(elapsed >= 100)
      if (false) println("tryAwait(.., 100) took " + elapsed + " millis")
    }
    ...
    test("tryAwait in atomic is conservative") {
      ...
      val elapsed = System.currentTimeMillis - t0
      assert(elapsed >= 100)
      if (false) println("tryAwait(.., 100) inside atomic took " + elapsed + " millis")
    }
    ...
    test("retryFor is conservative") {
      ...
      val elapsed = System.currentTimeMillis - t0
      assert(elapsed >= 100)
      if (false) println("retryFor(100) took " + elapsed + " millis")
    }
    ...
    test("late start retryFor") {
      ...
      if (false) println("late start retryFor(200) inside atomic took " + elapsed + " millis")
      assert(elapsed >= 200)
    ...
    test("expired start retryFor") {
      ...
      val elapsed = System.currentTimeMillis - begin
      if (false) println("expired(200) start retryFor(100) inside atomic took " + elapsed + " millis")
      assert(elapsed >= 200)
    ...
    test("retryFor as sleep") {
      ...
      val elapsed = System.currentTimeMillis - begin
      if (false) println("retryFor(100) as sleep took " + elapsed + " millis")
      assert(elapsed >= 100)
    }
